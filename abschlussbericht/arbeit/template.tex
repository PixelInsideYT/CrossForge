...
\begin{titlepage}
	\centering
	\includegraphics[width=0.5\textwidth]{pics/TU_Chemnitz_positiv_gruen}\par\vspace{1cm}
	{\scshape\Large Teamorientiertes Praktikum\par}
	\vspace{1.5cm}
	{\huge\bfseries Erzeugung interaktiver Umgebungen für verkörperte digitale Technologien\par}
